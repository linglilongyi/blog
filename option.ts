...
const options: z.input<typeof Options> = {
  ...
  title: '雨霖铃慢',
  website: 'https://linglilongyi.com',
  description: '过得到人过得到自己',
  keywords: ['龙一', '雨霖铃慢', '仙人掌', 'linglilongyi'],
  author: {
    name: '绫里龙一',
    email: 'linglilongyi@gmail.com',
    url: 'https://linglilongyi.com',
  },
  navigation: [
    {
      text: '首页',
  ...
  settings: {
    ...
    assetPrefix: 'https://image.linglilongyi.com',
    post: {
      sort: 'desc',
    },
    pagination: {
