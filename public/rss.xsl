  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        ...
        <div class="footer">
          <a class="title" href="https://linglilongyi.com" target="_blank">雨霖铃慢</a>
          <nav>
            <a href="https://linglilongyi.com/about">关于</a>
            <a href="https://linglilongyi.com/friend">友链</a>
            <a href="https://linglilongyi.com/categories">分类</a>
          </nav>
        </div>
      </body>
    </html>
